...
/**
 * Staff-alert-only / healthcare-occupancy input for {@link FireAlarmAudibilityCalculator},
 * evaluated against {@link AudibilityThresholdResolver#privateMode()}.
 *
 ...
 */
public record PrivateModeInput(
